...
u64_to_ptr * u64_to_ptr_create(const char * optional_name){
  static const char * const column_names[] = {(char *)"key", (char *)"value"};
  static const char * const column_types[] = {"u64", "void*"};
  u64_to_ptr * instance = calloc(sizeof(u64_to_ptr), 1);
  instance->column_names = (char **)column_names;
  instance->column_types = (char **)column_types;
  
  icy_table_init((icy_table * )instance, optional_name, 2, (unsigned int[]){sizeof(u64), sizeof(void*)}, (char *[]){(char *)"key", (char *)"value"});
  
  return instance;
}

void u64_to_ptr_insert(u64_to_ptr * table, u64 * key, void* * value, size_t count){
  void * array[] = {(void* )key, (void* )value};
  icy_table_inserts((icy_table *) table, array, count);
}

void u64_to_ptr_set(u64_to_ptr * table, u64 key, void* value){
  void * array[] = {(void* )&key, (void* )&value};
  icy_table_inserts((icy_table *) table, array, 1);
}

void u64_to_ptr_lookup(u64_to_ptr * table, u64 * keys, size_t * out_indexes, size_t count){
  icy_table_finds((icy_table *) table, keys, out_indexes, count);
}

void u64_to_ptr_remove(u64_to_ptr * table, u64 * keys, size_t key_count){
...
void u64_to_ptr_clear(u64_to_ptr * table){
  icy_table_clear((icy_table *) table);
}

void u64_to_ptr_unset(u64_to_ptr * table, u64 key){
  u64_to_ptr_remove(table, &key, 1);
}

bool u64_to_ptr_try_get(u64_to_ptr * table, u64 * key, void* * value){
  void * array[] = {(void* )key, (void* )value};
  ...
  unsigned int sizes[] = {sizeof(u64), sizeof(void*)};
  for(int i = 1; i < 2; i++){
    if(array[i] != NULL)
...
void u64_to_ptr_print(u64_to_ptr * table){
  icy_table_print((icy_table *) table);
}

size_t u64_to_ptr_iter(u64_to_ptr * table, u64 * keys, size_t keycnt, u64 * optional_keys_out, size_t * indexes, size_t cnt, size_t * iterator){
